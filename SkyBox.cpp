...
namespace gps {
    ...
    void SkyBox::Draw(gps::Shader shader, glm::mat4 viewMatrix, glm::mat4 projectionMatrix, GLfloat intensity)
    {
        ...
        glUniform1f(glGetUniformLocation(shader.shaderProgram, "intensity"), intensity);
